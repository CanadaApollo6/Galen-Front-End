                        ...
                        <Card title={`Plate - ${e}`}>
                            <Row gutter={30}>
                                ...
                                <Col span={16}>
                                    ...
                                    <h3>Inconclusive: {(determinations.filter(d => d.elution === e)).filter(d => d.determination === "Inconclusive").length - (determinations.filter(d => d.elution === e)).filter(d => d.sample_id === "neg" || d.sample_id === "pc").length}</h3>
