...
import Orf1abAmplification from "../ai/Orf1abAmplification";
...
export default async ({
    ...
    const model = (await Orf1abAmplification.getModel()) as tf.LayersModel;
    ...
    const ctValue = findIntersects(guideLine, orf1ab_delta);
